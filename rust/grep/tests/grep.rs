...
fn multiple_files_one_match_no_flags() {
	let pattern = "Agamemnon";
	let flags = Flags::new(&[]);
	let files = Files::new(&["2-1-iliad.txt", "2-1-midsummer-night.txt", "2-1-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
...
fn multiple_files_several_matches_no_flags() {
	let pattern = "may";
	let flags = Flags::new(&[]);
	let files = Files::new(&["2-2-iliad.txt", "2-2-midsummer-night.txt", "2-2-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[
...
fn multiple_files_several_matches_print_line_numbers_flag() {
	let pattern = "that";
	let flags = Flags::new(&["-n"]);
	let files = Files::new(&["2-3-iliad.txt", "2-3-midsummer-night.txt", "2-3-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[
...
fn multiple_files_one_match_print_file_names_flag() {
	let pattern = "who";
	let flags = Flags::new(&["-l"]);
	let files = Files::new(&["2-4-iliad.txt", "2-4-midsummer-night.txt", "2-4-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
...
fn multiple_files_several_matches_case_insensitive_flag() {
	let pattern = "TO";
	let flags = Flags::new(&["-i"]);
	let files = Files::new(&["2-5-iliad.txt", "2-5-midsummer-night.txt", "2-5-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[
...
fn multiple_files_several_matches_inverted_flag() {
	let pattern = "a";
	let flags = Flags::new(&["-v"]);
	let files = Files::new(&["2-6-iliad.txt", "2-6-midsummer-night.txt", "2-6-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[
...
fn multiple_files_one_match_match_entire_lines_flag() {
	...
	let flags = Flags::new(&["-x"]);
	let files = Files::new(&["2-7-iliad.txt", "2-7-midsummer-night.txt", "2-7-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
...
fn multiple_files_one_match_multiple_flags() {
	let pattern = "WITH LOSS OF EDEN, TILL ONE GREATER MAN";
	let flags = Flags::new(&["-n", "-i", "-x"]);
	let files = Files::new(&["2-8-iliad.txt", "2-8-midsummer-night.txt", "2-8-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
...
fn multiple_files_no_matches_various_flags() {
	let pattern = "Frodo";
	let flags = Flags::new(&["-n", "-l", "-x", "-i"]);
	let files = Files::new(&["2-9-iliad.txt", "2-9-midsummer-night.txt", "2-9-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[];
	assert_eq!(actual, expected);
}
...
fn multiple_files_several_matches_file_flag_takes_precedence_over_line_number_flag() {
	...
	let flags = Flags::new(&["-n", "-l"]);
	let files =
		Files::new(&["2-10-iliad.txt", "2-10-midsummer-night.txt", "2-10-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
...
fn multiple_files_several_matches_inverted_and_match_entire_lines_flags() {
	...
	let flags = Flags::new(&["-x", "-v"]);
	let files =
		Files::new(&["2-11-iliad.txt", "2-11-midsummer-night.txt", "2-11-paradise-lost.txt"]);
	let actual = grep(pattern, &flags, files.as_ref()).unwrap();
	let expected: &[&str] = &[
