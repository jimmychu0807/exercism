...
describe("Line Up", () => {
  it("format smallest non-exceptional ordinal numeral 4", () => {
    expect(format("Gianna", 4)).toBe("Gianna, you are the 4th customer we serve today. Thank you!");
  });
  ...
  it("format non-exceptional ordinal numeral 7", () => {
    expect(format("Kate", 7)).toBe("Kate, you are the 7th customer we serve today. Thank you!");
  });
  ...
  it("format exceptional ordinal numeral 1", () => {
    expect(format("Mary", 1)).toBe("Mary, you are the 1st customer we serve today. Thank you!");
  });

  it("format exceptional ordinal numeral 2", () => {
    expect(format("Haruto", 2)).toBe("Haruto, you are the 2nd customer we serve today. Thank you!");
  });
  ...
  it("format non-exceptional ordinal numeral 12", () => {
    expect(format("Juan", 12)).toBe("Juan, you are the 12th customer we serve today. Thank you!");
  });
  ...
  it("format exceptional ordinal numeral 21", () => {
    expect(format("Washi", 21)).toBe("Washi, you are the 21st customer we serve today. Thank you!");
  });

  it("format exceptional ordinal numeral 62", () => {
    expect(format("Nayra", 62)).toBe("Nayra, you are the 62nd customer we serve today. Thank you!");
  });

  it("format exceptional ordinal numeral 100", () => {
    expect(format("John", 100)).toBe("John, you are the 100th customer we serve today. Thank you!");
  });
  ...
  it("format exceptional ordinal numeral 112", () => {
    expect(format("Knud", 112)).toBe("Knud, you are the 112th customer we serve today. Thank you!");
  });

  it("format exceptional ordinal numeral 123", () => {
    expect(format("Yma", 123)).toBe("Yma, you are the 123rd customer we serve today. Thank you!");
  });
});
