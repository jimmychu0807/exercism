...
Welcome to Resistor Color Duo on Exercism's TypeScript Track. If you need help running the tests or
...
From the example above: brown-green should return 15, and brown-green-violet should return 15 too,
