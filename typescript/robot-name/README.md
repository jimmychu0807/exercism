...
Welcome to Robot Name on Exercism's TypeScript Track. If you need help running the tests or
...
The names must be random: they should not follow a predictable sequence. Using random names means a
risk of collisions. Your solution must ensure that every existing robot has a unique name.
